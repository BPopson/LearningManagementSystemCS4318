...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { course_id: @assignment.course_id, assignment_name: @assignment.assignment_name } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { course_id: @assignment.course_id, assignment_name: @assignment.assignment_name } }
